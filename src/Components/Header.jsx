      ...
      >
        ...
        >
          ...
          <button
            ...
            className="absolute top-7 right-6 text-black inline-flex items-center justify-center p-2 bg-[#fff] opacity-[60%] border-2 border-black rounded-tl-xl rounded-br-xl z-50"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
