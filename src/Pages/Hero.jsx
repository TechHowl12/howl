...
// // i have add this a backgound video in hero section but it is not working
    ...
    >
      ...
      <div className="relative hidden sm:block text-white leading-none">
        ...
        <p 
          data-scroll
          data-scroll-speed="0.3"
          className="leading-5 text-xl light mt-4 text-right"
         
         
        >
          Impressions & engagement are a means to an end.
          <br /> These digital metrics are a vanity signal, one we know 
          <br /> how to effortlessly achieve. More importantly, we know
          <br /> how to convert them into paying customers.
        </p>
